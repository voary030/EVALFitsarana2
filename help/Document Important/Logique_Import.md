...
1. [[#1. Principes généraux|1. Principes généraux]]
2. [[#2. Vue d'ensemble des dépendances|2. Vue d'ensemble des dépendances]]
3. [[#3. Phase 1 — Import du Fichier 1 (catalogue produits)|3. Phase 1 — Import du Fichier 1 (catalogue produits)]]
	1. [[#3. Phase 1 — Import du Fichier 1 (catalogue produits)#3.1 Pré-résolution des IDs de référence|3.1 Pré-résolution des IDs de référence]]
	2. [[#3. Phase 1 — Import du Fichier 1 (catalogue produits)#3.2 Calcul du prix HT|3.2 Calcul du prix HT]]
	3. [[#3. Phase 1 — Import du Fichier 1 (catalogue produits)#3.3 Séquence de création|3.3 Séquence de création]]
4. [[#4. Phase 2 — Import du Fichier 2 (déclinaisons + stocks)|4. Phase 2 — Import du Fichier 2 (déclinaisons + stocks)]]
	1. [[#4. Phase 2 — Import du Fichier 2 (déclinaisons + stocks)#4.1 Pré-résolution des attributs|4.1 Pré-résolution des attributs]]
	2. [[#4. Phase 2 — Import du Fichier 2 (déclinaisons + stocks)#4.2 Calcul du delta de prix des déclinaisons|4.2 Calcul du delta de prix des déclinaisons]]
	3. [[#4. Phase 2 — Import du Fichier 2 (déclinaisons + stocks)#4.3 Séquence de création|4.3 Séquence de création]]
5. [[#5. Phase 3 — Import du Fichier 3 (clients et commandes)|5. Phase 3 — Import du Fichier 3 (clients et commandes)]]
	1. [[#5. Phase 3 — Import du Fichier 3 (clients et commandes)#5.1 Déduplication des clients|5.1 Déduplication des clients]]
	2. [[#5. Phase 3 — Import du Fichier 3 (clients et commandes)#5.2 Résolution de l'adresse|5.2 Résolution de l'adresse]]
	3. [[#5. Phase 3 — Import du Fichier 3 (clients et commandes)#5.3 Parsing du champ `achat`|5.3 Parsing du champ `achat`]]
	4. [[#5. Phase 3 — Import du Fichier 3 (clients et commandes)#5.4 Calcul des totaux de commande|5.4 Calcul des totaux de commande]]
	5. [[#5. Phase 3 — Import du Fichier 3 (clients et commandes)#5.5 Séquence de création commande|5.5 Séquence de création commande]]
6. [[#6. Codes de retour HTTP|6. Codes de retour HTTP]]
7. [[#7. Structure des messages d'erreur PrestaShop|7. Structure des messages d'erreur PrestaShop]]
	1. [[#7. Structure des messages d'erreur PrestaShop#Format XML (défaut)|Format XML (défaut)]]
	2. [[#7. Structure des messages d'erreur PrestaShop#Format JSON (`?output_format=JSON`)|Format JSON (`?output_format=JSON`)]]
	3. [[#7. Structure des messages d'erreur PrestaShop#Codes d'erreur internes PrestaShop fréquents|Codes d'erreur internes PrestaShop fréquents]]
8. [[#8. Gestion des erreurs dans la séquence d'import|8. Gestion des erreurs dans la séquence d'import]]
9. [[#9. Points de vigilance spécifiques aux fichiers fournis|9. Points de vigilance spécifiques aux fichiers fournis]]
10. [[#10. Ordre d'exécution complet recommandé|10. Ordre d'exécution complet recommandé]]
