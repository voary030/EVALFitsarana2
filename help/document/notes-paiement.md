...
1. [Notes paiement et prix (declinaisons)](#notes-paiement-et-prix-declinaisons)
   - [1) Calcul du prix avec declinaisons et TVA](#1-calcul-du-prix-avec-declinaisons-et-tva)
   - [2) Eviter l erreur de paiement (PS_OS_ERROR)](#2-eviter-l-erreur-de-paiement-ps_os_error)
   - [3) Selection du mode de paiement et cle PS_OS_*](#3-selection-du-mode-de-paiement-et-cle-ps_os_)
   - [4) Resolution du statut de commande](#4-resolution-du-statut-de-commande)
   - [5) Transporteur apres creation](#5-transporteur-apres-creation)
   - [6) Endpoints Webservice utilises](#6-endpoints-webservice-utilises)
